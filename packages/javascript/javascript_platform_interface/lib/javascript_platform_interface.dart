...
abstract class JavaScriptPlatform extends PlatformInterface {
  ...
  /// Starts a new JavaScript engine.
  ///
  /// The [javascriptEngineId] is used to identify the engine and is used to
  /// communicate with the engine.
  ///
  /// The engine is started when the first JavaScript channel is added.
