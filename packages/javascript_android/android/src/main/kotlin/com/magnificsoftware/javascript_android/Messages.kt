...
abstract class MessagesPigeonProxyApiRegistrar(val binaryMessenger: BinaryMessenger) {
  ...
  /**
   * An implementation of [PigeonApiJavaScriptAndroidConsoleMessageHandler] used to add a new Dart instance of
   * `JavaScriptAndroidConsoleMessageHandler` to the Dart `InstanceManager`.
   */
  abstract fun getPigeonApiJavaScriptAndroidConsoleMessageHandler(): PigeonApiJavaScriptAndroidConsoleMessageHandler

  fun setUp() {
    MessagesPigeonInstanceManagerApi.setUpMessageHandlers(binaryMessenger, instanceManager)
    PigeonApiJavaScriptAndroidConsoleMessageHandler.setUpMessageHandlers(binaryMessenger, getPigeonApiJavaScriptAndroidConsoleMessageHandler())
  }
  fun tearDown() {
    MessagesPigeonInstanceManagerApi.setUpMessageHandlers(binaryMessenger, null)
    PigeonApiJavaScriptAndroidConsoleMessageHandler.setUpMessageHandlers(binaryMessenger, null)
  }
}
private class MessagesPigeonProxyApiBaseCodec(val registrar: MessagesPigeonProxyApiRegistrar) : MessagesPigeonCodec() {
  ...
  override fun writeValue(stream: ByteArrayOutputStream, value: Any?) {
    ...
    if (value is JavaScriptAndroidConsoleMessageHandler) {
      registrar.getPigeonApiJavaScriptAndroidConsoleMessageHandler().pigeon_newInstance(value) { }
    }
...
abstract class PigeonApiJavaScriptAndroidConsoleMessageHandler(open val pigeonRegistrar: MessagesPigeonProxyApiRegistrar) {
  abstract fun pigeon_defaultConstructor(): JavaScriptAndroidConsoleMessageHandler

  companion object {
    @Suppress("LocalVariableName")
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiJavaScriptAndroidConsoleMessageHandler?) {
      val codec = api?.pigeonRegistrar?.codec ?: MessagesPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.javascript_android.JavaScriptAndroidConsoleMessageHandler.pigeon_defaultConstructor", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
  ...
  /** Creates a Dart instance of JavaScriptAndroidConsoleMessageHandler and attaches it to [pigeon_instanceArg]. */
  fun pigeon_newInstance(pigeon_instanceArg: JavaScriptAndroidConsoleMessageHandler, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              FlutterError("new-instance-error", "Attempting to create a new Dart instance of JavaScriptAndroidConsoleMessageHandler, but the class has a nonnull callback method.", "")))
    }
  }

  /** Handles callbacks messages from JavaScript. */
  fun onMessage(pigeon_instanceArg: JavaScriptAndroidConsoleMessageHandler, messageArg: String, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
    ...
    val channelName = "dev.flutter.pigeon.javascript_android.JavaScriptAndroidConsoleMessageHandler.onMessage"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
...
interface JavaScriptAndroidPlatformApi {
  fun startJavaScriptEnvironment(javascriptInstanceId: String, callback: (Result<Unit>) -> Unit)
  fun dispose(javascriptInstanceId: String, callback: (Result<Unit>) -> Unit)
  fun runJavaScriptReturningResult(javascriptInstanceId: String, javaScript: String, callback: (Result<String?>) -> Unit)
  fun runJavaScriptFromFileReturningResult(javascriptInstanceId: String, javaScriptFilePath: String, callback: (Result<String?>) -> Unit)
  fun setIsInspectable(javascriptInstanceId: String, isInspectable: Boolean, callback: (Result<Unit>) -> Unit)
  fun setJavaScriptConsoleMessageHandler(javascriptInstanceId: String, mJavaScriptAndroidConsoleMessageHandlerInstanceIdentifier: Long, callback: (Result<Boolean>) -> Unit)
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: JavaScriptAndroidPlatformApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.javascript_android.JavaScriptAndroidPlatformApi.startJavaScriptEnvironment$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val javascriptInstanceIdArg = args[0] as String
            api.startJavaScriptEnvironment(javascriptInstanceIdArg) { result: Result<Unit> ->
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val javascriptInstanceIdArg = args[0] as String
            api.dispose(javascriptInstanceIdArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(MessagesPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            api.runJavaScriptReturningResult(javascriptInstanceIdArg, javaScriptArg) { result: Result<String?> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(MessagesPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            api.runJavaScriptFromFileReturningResult(javascriptInstanceIdArg, javaScriptFilePathArg) { result: Result<String?> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(MessagesPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            api.setIsInspectable(javascriptInstanceIdArg, isInspectableArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(MessagesPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.javascript_android.JavaScriptAndroidPlatformApi.setJavaScriptConsoleMessageHandler$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val javascriptInstanceIdArg = args[0] as String
            val mJavaScriptAndroidConsoleMessageHandlerInstanceIdentifierArg = args[1] as Long
            api.setJavaScriptConsoleMessageHandler(javascriptInstanceIdArg, mJavaScriptAndroidConsoleMessageHandlerInstanceIdentifierArg) { result: Result<Boolean> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(MessagesPigeonUtils.wrapError(error))
              } else {
