...
The Android implementation of [javascript](https://pub.dev/packages/javascript) which provides access to a JavaScript environment through [JavaScriptAndroid] platform.
